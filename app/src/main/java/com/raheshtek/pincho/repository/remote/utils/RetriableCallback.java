package com.raheshtek.pincho.repository.remote.utils;
...
public abstract class RetriableCallback<T> implements Callback<T> {

    private static final String TAG = RetriableCallback.class.getSimpleName();
    ...
    public RetriableCallback() {

    }


    public RetriableCallback(int maxRetry) {
        this.maxRetry = maxRetry;
    }


    public RetriableCallback(int maxRetry, int maxTimerRetry) {
        this.maxRetry = maxRetry;
